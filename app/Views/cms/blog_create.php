        ...
        <form id="blogPostForm" class="space-y-4 bg-slate-900/80 border border-slate-800 rounded-2xl p-5 shadow-xl shadow-slate-950/40">
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    <div id="coverPreviewWrap" class="shrink-0 w-32 h-[4.5rem] rounded-lg overflow-hidden border border-slate-700 bg-slate-950/50 flex items-center justify-center">
                        <img id="coverPreviewImg" alt="" class="w-full h-full object-cover hidden">
                        <span id="coverPreviewPlaceholder" class="text-[10px] text-slate-500 px-2 text-center">Nessuna copertina</span>
                    </div>
                    <div class="flex flex-col gap-1.5">
                        ...
                        <button type="button" id="removeCoverButton"
                            class="px-3 py-1.5 rounded-lg border border-slate-700 text-xs font-medium text-red-300 hover:bg-red-950/40 hover:border-red-800 transition hidden">
                            Rimuovi copertina
                        </button>
                    </div>
                </div>
            ...
            <div>
                ...
                <textarea name="content" id="blogContent" rows="16" required
                    class="block w-full border border-slate-700 bg-slate-950/60 rounded-lg shadow-sm p-3 text-sm text-slate-200 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition font-mono leading-relaxed resize-y"
                ...
                <p class="mt-1 text-[10px] text-slate-500">
                    Formule: <code class="text-slate-400">$a^2+b^2=c^2$</code> · Video: <code class="text-slate-400">@[video](https://youtube.com/watch?v=...)</code>
                </p>
            </div>
